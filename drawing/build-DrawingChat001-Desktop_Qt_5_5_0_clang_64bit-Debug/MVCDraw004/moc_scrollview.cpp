...
#include "../../DrawingChat001/MVCDraw004/view/scrollview.h"
...
void ScrollView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ScrollView *_t = static_cast<ScrollView *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject ScrollView::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ScrollView.data,
      qt_meta_data_ScrollView,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ScrollView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ScrollView.stringdata0))
        return static_cast<void*>(const_cast< ScrollView*>(this));
